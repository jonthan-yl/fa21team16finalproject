...
namespace fa21team16finalproject.Utilities
{
    public static class EmailMessaging
    {
        public static void SendEmail(String toEmailAddress, String emailSubject, String emailBody)
        {
            ...
            //This is the address that will be SENDING the emails (the FROM 
            //address)
            //TODO: Change this to YOUR TEAM's email address
            String strFromEmailAddress = "fa21team16@gmail.com";
            //This is the password for YOUR TEAM'S "fake" Gmail account
            //TODO: Change this password to your team's Gmail account password
            String strPassword = "Password16!";
            //This is the name of the business from which you are sending
            //TODO: Change this to the name of the company you are creating the 
            //website for

            String strCompanyName = "MIS 333K Team 16";
            ...
            //Create an email client to send the emails
                ...
                Credentials = new NetworkCredential(strFromEmailAddress,
            strPassword),
                            EnableSsl = true
                        };
            //Add anything that you need to the body of the message
            //emailBody is passed into the method as a parameter
            // /n is a new line – this will add some white space after the main 
            //body of the message
            //TODO: Change or remove the disclaimer below
            String finalMessage = emailBody + "\n\n BEVO BNB";
            //Create an email address object for the sender address
            MailAddress senderEmail = new MailAddress(strFromEmailAddress,
            strCompanyName);
            ...
            mm.From = senderEmail;
            //Add the recipient (passed in as a parameter) to the list of people 
            //receiving the email
